 ...
 */
grammar InternalMathCompilerDsl;
...
// Entry rule entryRuleMathLang
entryRuleMathLang returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getMathLangRule()); }
	iv_ruleMathLang=ruleMathLang
	{ $current=$iv_ruleMathLang.current; }
	EOF;

// Rule MathLang
ruleMathLang returns [EObject current=null]
@init {
	enterRule();
}
@after {
